		...
		BackAndroid.addEventListener('hardwareBackPress', () => {
			if (this.props.navigator && this.props.navigator.getCurrentRoutes().length > 1) {
				if (this.props.route.callback)
					this.props.route.callback(Page.CONTACT_INFO_PAGE)
				...
				<View style={[{ backgroundColor: '#0086ff', height:68, marginBottom:2 }]}>
					<View style={[styles.view, { flexDirection: 'row' }]}>
						...
						<View style={{
							...
							<Text style={styles.text}>{chat.info.last_active}</Text>
						</View>
					</View>
				</View>
				<ScrollView style={{flex:1}} keyboardDismissMode='interactive'>
					...
					<Card fullWidth='0'>
						<View style={styles.view}>
							...
							<Text style={styles.textBody}>Messages you send to this chat is secured with end-to-end encyption.</Text>
						</View>
					</Card>
					<Card fullWidth='0'>
						<View style={styles.view}>
							<Text style={styles.textBodyBold}>Email</Text>
							<Text style={styles.textBody}>{chat.info.email}</Text>
						</View>
					</Card>
